import {dateUtils} from '../../../rad-commons.js';
...
class DateTimePicker extends preact.Component {
     ...
     */
    render() {
        return $el('div', {className: 'datepicker'},
            $el('input', {type: this.props.showInput !== false ? 'text' : 'hidden',
                          name: this.props.inputName || 'date',
                          ref: el => { this.field = el; },
                          autocomplete: 'off'}),
            $el('div', {className: 'datepicker-container',
